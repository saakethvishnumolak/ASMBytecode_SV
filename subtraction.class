...
public class subtraction {
    public static void main (String [] args) {
...

        {
            ...
            mv.visitInsn(Opcodes.DSUB); // Subtract 3 from 1
            ...
            mv.visitInsn(Opcodes.ISUB); // subtract 3 from 1
            ...
            mv.visitInsn(Opcodes.JSUB); // subtract 3 from 1
            ...
            mv.visitInsn(Opcodes.FSUB); // subtract 3 from 1
